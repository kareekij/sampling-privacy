...
f = open("./output/output_"+sys.argv[1]+"_"+sys.argv[2]+".csv","w")
f.write("FILENAME, RAND, RAND All, BASIC, BASIC All, AGG, AGG All, BLOCK, BLOCK All, SVM, SVM All, NN, NN All\n")
...
for fileName in glob.glob("../sampling/output/"+sys.argv[2]+"/*"):
    ...
    print "TargetID, Label: {0}".format((onlyTarget, np.argmax(userLabel[onlyTarget])))
